      ...
      <div className="row text-center mb-5 g-3">
        {[
          ...
          <div className="col-12 col-sm-6 col-md-3" key={index}>
            <div className="p-1">
              <div
                className="rounded shadow-sm h-100 d-flex flex-column justify-content-between py-3"
                style={{
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = `0 0 12px ${m.color}`;
                }}
                onMouseLeave={(e) => {
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderColor: isActive ? "#6c5ce7" : "#ccc",
